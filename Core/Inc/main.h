...
#define READ_BRAKE_TEMP_TASK_ENABLED 1
...
#define RR_WHEEL_S_Pin GPIO_PIN_8
#define RR_WHEEL_S_GPIO_Port GPIOA
#define RL_WHEEL_S_Pin GPIO_PIN_9
#define RL_WHEEL_S_GPIO_Port GPIOA
#define FR_WHEEL_S_Pin GPIO_PIN_10
#define FR_WHEEL_S_GPIO_Port GPIOA
#define FL_WHEEL_S_Pin GPIO_PIN_11
#define FL_WHEEL_S_GPIO_Port GPIOA
