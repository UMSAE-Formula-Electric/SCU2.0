...
/* Private defines -----------------------------------------------------------*/
#define CAN_TX_TASK_ENABLED 0
#define READ_TEMP_TASK_ENABLED 1
#define IWDG_RELOAD_PERIOD 4094
#define READ_SPEEDS_TASK_ENABLED 0
#define IWDG_EVENT_ALL_ALLOWED_BITS 0xFFFFFF
#define IMU_CAN_PROC_TASK_ENABLED 0
#define READ_FLOW_TASK_ENABLED 0
#define CAN_RX_TASK_ENABLED 0
#define DEFAULT_TASK_ENABLED 0
#define READ_SHOCKS_TASK_ENABLED 0
