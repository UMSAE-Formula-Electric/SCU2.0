...
/* USER CODE BEGIN 0 */
volatile int wheel_FL_pulse_count 	= 0;
volatile int wheel_FR_pulse_count 	= 0;
volatile int wheel_RL_pulse_count 	= 0;
volatile int wheel_RR_pulse_count 	= 0;
/* USER CODE END 0 */
...
void HAL_TIM_IC_MspInit(TIM_HandleTypeDef* tim_icHandle)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    PA11     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = RR_WHEEL_S_Pin|RL_WHEEL_S_Pin|FR_WHEEL_S_Pin|FL_WHEEL_S_Pin;
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* tim_icHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA11     ------> TIM1_CH4
    */
    HAL_GPIO_DeInit(GPIOA, RR_WHEEL_S_Pin|RL_WHEEL_S_Pin|FR_WHEEL_S_Pin|FL_WHEEL_S_Pin);
